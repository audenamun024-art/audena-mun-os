...
const allEvents = [
  { id: 1, title: "Delhi International MUN 2026", date: "Mar 15–17, 2026", location: "New Delhi", delegates: 450, fee: "₹1,200", committees: 12, status: "Open" },
  { id: 2, title: "Mumbai Model United Nations", date: "Apr 5–7, 2026", location: "Mumbai", delegates: 320, fee: "₹800", committees: 8, status: "Open" },
  { id: 3, title: "National Youth Parliament", date: "May 1–3, 2026", location: "Bangalore", delegates: 280, fee: "₹600", committees: 6, status: "Open" },
  { id: 4, title: "Kolkata MUN Conference", date: "Jun 12–14, 2026", location: "Kolkata", delegates: 200, fee: "₹500", committees: 8, status: "Upcoming" },
  { id: 5, title: "Chennai Diplomacy Summit", date: "Jul 20–22, 2026", location: "Chennai", delegates: 180, fee: "₹700", committees: 6, status: "Upcoming" },
  { id: 6, title: "Hyderabad Global Affairs MUN", date: "Aug 8–10, 2026", location: "Hyderabad", delegates: 350, fee: "₹900", committees: 10, status: "Upcoming" },
];
      ...
      <div className="space-y-4">
        ...
        <div className="px-4 space-y-3 pb-4">
          {filtered.map((event) => (
            ...
            >
              <div className="bg-navy-gradient rounded-lg h-32 mb-3 flex items-center justify-center">
