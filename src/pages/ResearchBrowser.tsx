...
import { Globe, Shield, AlertTriangle, ExternalLink, Lock, RefreshCw } from "lucide-react";
        ...
        <div className="bg-card border-b border-border px-4 py-2 space-y-2">
          <form onSubmit={handleSubmit} className="flex items-center gap-2">
            <div className="relative flex-1">
              ...
              <Input value={url} onChange={(e) => setUrl(e.target.value)} placeholder="Enter URL (whitelisted domains only)" className="pl-8 h-9 text-sm bg-secondary border-border" />
            </div>
            <Button type="submit" size="sm" className="bg-primary text-primary-foreground h-9 text-xs px-4">Go</Button>
          </form>
        ...
        <div className="flex-1 overflow-hidden">
          ...
          {blocked && (
            <div className="flex flex-col items-center justify-center p-6 h-full">
              ...
              <h2 className="text-lg font-bold text-foreground mb-2">Access Blocked</h2>
